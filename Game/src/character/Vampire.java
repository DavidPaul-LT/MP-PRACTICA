...
public class Vampire extends Character{
    ...
    public int calculateAttackPotential(){
        ...
        int attPot = power + armorAtt + weaponAtt + getAditionalPotential() + modsAtt + disciplineAtt;
        return attPot;
    }
    public int calculateDefensePotential(){
        ...
        int defPot = power + armorDef + weaponDef + getAditionalPotential() + modsDef + disciplineDef;
        return defPot;
    }
}
